...
def seed_initial_data():
    ...
    initial_items = [
        ...
        PointItem(name="一天之内学习期间被发现摸鱼一次", points=-1, description="学习专注度不足", enabled=True),
        PointItem(name="一天之内学习期间被发现摸鱼两次", points=-2, description="学习专注度较差", enabled=True),
        PointItem(name="一天之内学习期间被发现摸鱼三次以上", points=-5, description="学习专注度很差", enabled=True),
